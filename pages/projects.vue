      ...
      <v-timeline align-top :dense="$vuetify.breakpoint.smAndDown">
        <v-timeline-item fill-dot v-for="(item, i) in data" :key="i">
          ...
          <v-card color="primary" dark>
            ...
            <v-card-text class="white text--primary pt-3" v-text="item.text"></v-card-text>
    ...
    return {
      data: [
        ...
        },
        {
          ...
          title: "Vivre",
          text:
            "In a university course, we were building real applications with real customers. I was managing a team, by the side of programming and planning work, that was creating an App for Weinmann Emergency. The App should improve the information flow of patient data and life signs on the way from the emergency side to the hospital."
        },
        {
          time: "2018 - today",
        ...
        },
        {
          ...
          text:
            "I'm currently working at a consulting company for housing companies. In my position as a full-stack developer, I'm planning and developing different big data and analytical applications."
        }
      ]
    };
  }
